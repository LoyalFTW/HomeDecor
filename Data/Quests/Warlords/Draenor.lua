...
NS.Data.Quests["Warlords"]["Draenor"] = {
 ...
 -- Need to fix this so it shows properly since it has no vendor
 ...
 -- { decorID=12202, title="Scroll of the Adherent", decorType="Ornamental", source={type="quest", itemID=1263927}, requirements={quest={id=33582, title="Kura's Vengeance"}, rep="true"}},   -- No vendor
