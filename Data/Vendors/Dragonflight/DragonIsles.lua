...
NS.Data.Vendors["Dragonflight"]["DragonIsles"] = {

  {
    ...
    items={
      {decorID=716, source={type="vendor", itemID=245285, currency="100", currencytype=2003}, requirements={rep="true"}},
      {decorID=717, source={type="vendor", itemID=245287, currency="250", currencytype=2003}},
      {decorID=718, source={type="vendor", itemID=245288, currency="250", currencytype=2003}},
      {decorID=720, source={type="vendor", itemID=238975, currency="750", currencytype=2003}, requirements={rep="true"}},
      {decorID=1177, source={type="vendor", itemID=245283, currency="400", currencytype=2003}, requirements={rep="true"}},
      {decorID=1181, source={type="vendor", itemID=245286, currency="250", currencytype=2003}},
    }
  },
...

  {
    ...
    items={
      {decorID=2529, source={type="vendor", itemID=246863}, requirements={quest={id=66001}}},
    }
  },
...

  {
    ...
    items={
      {decorID=4173, source={type="vendor", itemID=248117, currency="4000", currencytype=2657}},
    }
  },
...

  {
    ...
    items={
      {decorID=10888, source={type="vendor", itemID=255673}},
    }
  },
...

  {
    ...
    items={
      {decorID=2470, source={type="vendor", itemID=246707}},
    }
  },

  {
    ...
    items={
      {decorID=763, source={type="vendor", itemID=245293, currency="1200", currencytype=2815}, requirements={rep="true"}},
    }
  },
