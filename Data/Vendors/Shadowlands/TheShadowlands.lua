...
NS.Data.Vendors["Shadowlands"]["TheShadowlands"] = {
  ...
  },
  {
    ...
    items={
      --       {decorID=14583,  source={type="vendor", itemID=262453}}, -- Early Access / Midnight pre-patch
    }
  },
  {
    source={
    ...
    items={
      {decorID=4181,  source={type="vendor", itemID=248125, currency="10000", currencytype="Stygia"}, requirements={achievement={id=20501}}}}
  },
  {
    source={
      id=174710,
    ...
    items={
      {decorID=756,  source={type="vendor", itemID=245501, currency="1500", currencytype="Reservoir Anima"}}}
  }}
