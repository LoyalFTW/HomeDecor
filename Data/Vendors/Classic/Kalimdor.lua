...
NS.Data.Vendors["Classic"]["Kalimdor"] = {
  ...
  },
  {
    ...
    items={
      {decorID=1482, title="Sethraliss Priest's Pillow", decorType="Ornamental", source={type="vendor", itemID=244778, currency="200", currencytype="War Resources"}, requirements={rep="true"}},
    }
  },
  {
    title="Brave Tuho",
