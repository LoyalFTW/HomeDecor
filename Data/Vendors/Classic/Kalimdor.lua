...
NS.Data.Vendors["Classic"]["Kalimdor"] = {
...

  {
    ...
    items={
      {decorID=14583, source={type="vendor", itemID=262453, currency="500", currencytype="gold"}},
    }
  },
...

  {
    ...
    items={
      ...
      {decorID=1482, source={type="vendor", itemID=244778, costs={{currency="2", currencytype="gold"},{currency="50", currencytype="silver"}}}},
...

  {
    source={
      ...
      faction="Neutral",
      zone="Orgrimmar",
      worldmap="85:4840:8080"
    },
    items={
      {decorID=14467, source={type="vendor", itemID=260785, currency="1425", currencytype="gold"}},
    }
  },
