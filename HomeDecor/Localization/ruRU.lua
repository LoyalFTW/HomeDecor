local ADDON, NS = ...
local L = LibStub("AceLocale-3.0"):NewLocale("HomeDecor", "ruRU")
...
L["LUMBER_TRACK_LUMBER"]            = "Отслеживать древесину"
L["LUMBER_TRACK_LUMBER_TIP"]        = "Показывать древесину в трекере."
L["LUMBER_TRACK_ORE"]               = "Отслеживать руду"
L["LUMBER_TRACK_ORE_TIP"]           = "Показывать руду и камень в трекере."
L["LUMBER_TRACK_HERBS"]             = "Отслеживать травы"
L["LUMBER_TRACK_HERBS_TIP"]         = "Показывать травы в трекере."
...
L["LUMBER_HIDE_IN_INSTANCE"]        = "Скрывать в подземельях и инстах"
L["LUMBER_HIDE_IN_INSTANCE_TIP"]    = "Автоматически скрывает окна трекера древесины и статистики фарма при входе в подземелье, рейд или PvP-инстанс"
...
L["OPT_GATHER_MINI_TRACKERS"]       = "Материалы"
L["OPT_GATHER_OPEN_LUMBER"]         = "Открывать древесину"
L["OPT_GATHER_OPEN_ORE"]            = "Открывать руду"
L["OPT_GATHER_OPEN_HERB"]           = "Открывать травы"
L["OPT_GATHER_OPEN_ALL"]            = "Открывать все материалы"
L["OPT_GATHER_FARM_LUMBER"]         = "Фарм древесины"
L["OPT_GATHER_FARM_ORE"]            = "Фарм руды"
L["OPT_GATHER_FARM_HERB"]           = "Фарм трав"
