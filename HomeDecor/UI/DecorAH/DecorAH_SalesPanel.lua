...
local function CreateSalesPanel(parent)
  ...
  C:TextColor(summaryTitle, "textMuted")
  ...
  C:TextColor(summarySales, "textMuted")
  ...
  C:TextColor(summaryProfit, "text")
