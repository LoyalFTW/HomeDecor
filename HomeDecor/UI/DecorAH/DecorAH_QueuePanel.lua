...
local function CreateStyledButton(parent, width, height, text, role)
  ...
  C:TextColor(btnText, role or "text")
...
function QueuePanel:Create(parent, width, height)
  ...
  C:TextColor(queueFrame.queueCount, "accent")
  ...
  C:TextColor(summaryTitle, "accent")
  ...
  C:TextColor(profitLabel, "textMuted")
  ...
  C:TextColor(materialsText, "text")
...
function QueuePanel:Refresh()
  ...
  for i, entry in ipairs(queue) do
    ...
    if not row then
      ...
      C:TextColor(row.countText, "accent")
...
function QueuePanel:UpdateMaterialsSummary()
  ...
  if totalProfitText and Queue.GetTotalProfit then
    ...
    if profit > 0 then
      C:TextColor(totalProfitText, "success")
    elseif profit < 0 then
      C:TextColor(totalProfitText, "danger")
    else
      C:TextColor(totalProfitText, "textMuted")
    end
  end
