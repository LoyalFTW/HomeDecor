...
function LumberList:Create(sharedCtx)
  ...
  NS.UI.Util.BindBorderHover(collapseBtn, T.accentBright or T.accent, T.border)
  ...
  NS.UI.Util.BindBorderHover(settingsBtn, T.accentBright or T.accent, T.border)
  ...
  NS.UI.Util.BindBorderHover(closeBtn, T.accentBright or T.accent, T.border)
  ...
  C:TextColor(startFarmingBtn.text, "success")
