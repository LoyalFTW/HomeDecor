...
NS.Data.Vendors["WarWithin"]["KhazAlgar"] = {
...

  {
    ...
    items={
      {decorID=9236, source={type="vendor", itemID=253162, costs={{currency="600", currencytype=2815},{currency="600", currencytype=2815}}}},
    }
  },

  {
    ...
    items={
      {decorID=760, source={type="vendor", itemID=245295, currency="1000", currencytype=2815}},
      {decorID=761, source={type="vendor", itemID=245296, currency="1000", currencytype=2815}},
      {decorID=762, source={type="vendor", itemID=245297, currency="1000", currencytype=2815}},
      {decorID=1750, source={type="vendor", itemID=245561, currency="620", currencytype=2815}},
...

  {
    ...
    items={
      {decorID=1277, source={type="vendor", itemID=245309, currency="15", currencytype="\"Gold\" Fish"}},
    }
  },
...

  {
    ...
    items={
      {decorID=1257, source={type="vendor", itemID=245314, costs={{currency="650", currencytype=2815},{currency="850", currencytype=2815}}}},
      {decorID=1258, source={type="vendor", itemID=243312, costs={{currency="700", currencytype=2815},{currency="900", currencytype=2815}}}},
      {decorID=1262, source={type="vendor", itemID=245319, costs={{currency="350", currencytype=2815},{currency="350", currencytype=2815}}}},
      {decorID=1263, source={type="vendor", itemID=245318, costs={{currency="450", currencytype=2815},{currency="450", currencytype=2815}}}},
    }
  },
...

  {
    ...
    items={
      {decorID=11930, source={type="vendor", itemID=258262, currency="350", currencytype=2815}, requirements={quest={id=79510}}},
      {decorID=11931, source={type="vendor", itemID=258264, currency="200", currencytype=2815}, requirements={quest={id=78642}}},
      {decorID=11932, source={type="vendor", itemID=258265, currency="1000", currencytype=2815}, requirements={quest={id=80516}}},
      {decorID=11933, source={type="vendor", itemID=258267, currency="750", currencytype=2815}, requirements={quest={id=79565}}},
    }
  },
