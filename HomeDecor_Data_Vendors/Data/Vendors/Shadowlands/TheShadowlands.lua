...
NS.Data.Vendors["Shadowlands"]["TheShadowlands"] = {

  {
    ...
    items={
      {decorID=4181, source={type="vendor", itemID=248125, currency="10000", currencytype=1767}, requirements={achievement={id=20501}}, colors={"Blue","Cyan","Royal Blue"}, budgetCost=5, size="Huge"},
    }
  },
