...
NS.Data.Vendors["Classic"]["EasternKingdoms"] = {
...

  {
    ...
    items={
      {decorID=1481, source={type="vendor", itemID=244777, currency="1100", currencytype="gold"}, requirements={quest={id=25720}}},
    }
  },
...

  {
    ...
    items={
      {decorID=11131, source={type="vendor", itemID=256331, currency="450", currencytype="gold"}, requirements={quest={id=28183}}},
    }
  },
