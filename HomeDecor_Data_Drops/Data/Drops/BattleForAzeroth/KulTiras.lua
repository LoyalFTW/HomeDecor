...
NS.Data.Drops["BattleForAzeroth"]["KulTiras"] = {
    ...
    {decorID=25337, source={type="drop", zone="Ral'kala", itemID=278154, name="Ral'kala"}, budgetCost=3, size="Medium"},
    {decorID=26208, source={type="encounter", zone="Kings' Rest - Dazar, The First King", itemID=278245, name="Kings' Rest - Dazar, The First King"}, budgetCost=3, size="Large"},
    {decorID=26198, source={type="encounter", zone="Temple of Sethraliss - Avatar of Sethraliss", itemID=278982, name="Temple of Sethraliss - Avatar of Sethraliss"}, budgetCost=5, size="Huge"},
}
