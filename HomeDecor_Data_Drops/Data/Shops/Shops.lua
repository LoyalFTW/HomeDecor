...
NS.Data.Shops["Midnight"]["QuelThalas"] = {
    ...
    {decorID=9265, source={type="shop", zone="Shop", itemID=253244, name="Shop"}, dyeable=true, budgetCost=5, size="Medium"},
    {decorID=9273, source={type="shop", zone="Shop", itemID=253257, name="Shop"}, dyeable=true, budgetCost=5, size="Medium"},
    {decorID=9280, source={type="shop", zone="Shop", itemID=253296, name="Shop"}, budgetCost=1, size="Small"},
    {decorID=16098, source={type="shop", zone="Shop", itemID=264721, name="Shop"}, colors={"Dark Brown","Light Brown","Royal Blue"}, budgetCost=5, size="Large"},
    {decorID=16099, source={type="shop", zone="Shop", itemID=264722, name="Shop"}, colors={"Dark Brown","Deep Red","Light Brown"}, budgetCost=3, size="Medium"},
    {decorID=16100, source={type="shop", zone="Shop", itemID=264723, name="Shop"}, colors={"Beige","Forest Green","Red"}, budgetCost=3, size="Medium"},
    {decorID=16101, source={type="shop", zone="Shop", itemID=264724, name="Shop"}, colors={"Beige","Brown","Teal"}, budgetCost=1, size="Small"},
    {decorID=16102, source={type="shop", zone="Shop", itemID=264725, name="Shop"}, colors={"Forest Green","Gray","Purple"}, budgetCost=5, size="Large"},
    {decorID=17750, source={type="shop", zone="Shop", itemID=266071, name="Shop"}, colors={"Dark Brown","Dark Gray","Tan"}, budgetCost=3, size="Small"},
    {decorID=21060, source={type="shop", zone="Shop", itemID=269604, name="Shop"}, colors={"Dark Brown","Deep Red","Tan"}, budgetCost=1, size="Small"},
    {decorID=21061, source={type="shop", zone="Shop", itemID=269605, name="Shop"}, colors={"Dark Brown","Dark Gray","Gray"}, budgetCost=1, size="Small"},
    {decorID=21945, source={type="shop", zone="Shop", itemID=272353, name="Shop"}, budgetCost=3, size="Small"},
    {decorID=21946, source={type="shop", zone="Shop", itemID=272354, name="Shop"}, budgetCost=5, size="Large"},
    {decorID=21949, source={type="shop", zone="Shop", itemID=272358, name="Shop"}, budgetCost=1, size="Tiny"},
    {decorID=22144, source={type="shop", zone="Shop", itemID=274784, name="Shop"}, dyeable=true, budgetCost=3, size="Medium"},
    {decorID=22397, source={type="shop", zone="Shop", itemID=274899, name="Shop"}, dyeable=true, budgetCost=5, size="Large"},
    {decorID=22398, source={type="shop", zone="Shop", itemID=274897, name="Shop"}, dyeable=true, budgetCost=3, size="Medium"},
    {decorID=22895, source={type="shop", zone="Shop", itemID=274901, name="Shop"}, dyeable=true, budgetCost=3, size="Medium"},
    {decorID=23175, source={type="shop", zone="Shop", itemID=274767, name="Shop"}, dyeable=true, budgetCost=3, size="Medium"},
    {decorID=23868, source={type="shop", zone="Shop", itemID=274903, name="Shop"}, dyeable=true, budgetCost=3, size="Medium"},
    {decorID=23869, source={type="shop", zone="Shop", itemID=274905, name="Shop"}, dyeable=true, budgetCost=5, size="Large"},
    {decorID=23870, source={type="shop", zone="Shop", itemID=274907, name="Shop"}, dyeable=true, budgetCost=3, size="Medium"},
    {decorID=23883, source={type="shop", zone="Shop", itemID=274786, name="Shop"}, budgetCost=5, size="Medium"},
    {decorID=24196, source={type="shop", zone="Shop", itemID=274788, name="Shop"}, budgetCost=1, size="Small"},
    {decorID=24630, source={type="shop", zone="Shop", itemID=274909, name="Shop"}, dyeable=true, budgetCost=3, size="Medium"},
    {decorID=24753, source={type="shop", zone="Shop", itemID=274988, name="Shop"}, budgetCost=5, size="Huge"},
    {decorID=24755, source={type="shop", zone="Shop", itemID=274991, name="Shop"}, budgetCost=3, size="Large"},
