...
--     {decorID=16098, source={type="shop", zone="Unknown Promo/Shop item", itemID=264721, name="Unknown Promo/Shop item"}, dyeable=true, colors={"Dark Brown","Light Brown","Royal Blue"}, budgetCost=5, size="Large"}, -- UNKNOWN PROMO/SHOP ITEM
--     {decorID=16099, source={type="shop", zone="Unknown Promo/Shop item", itemID=264722, name="Unknown Promo/Shop item"}, dyeable=true, colors={"Dark Brown","Deep Red","Light Brown"}, budgetCost=3, size="Medium"}, -- UNKNOWN PROMO/SHOP ITEM
--     {decorID=16100, source={type="shop", zone="Unknown Promo/Shop item", itemID=264723, name="Unknown Promo/Shop item"}, dyeable=true, colors={"Beige","Forest Green","Red"}, budgetCost=3, size="Medium"}, -- UNKNOWN PROMO/SHOP ITEM
--     {decorID=16101, source={type="shop", zone="Unknown Promo/Shop item", itemID=264724, name="Unknown Promo/Shop item"}, dyeable=true, colors={"Beige","Brown","Teal"}, budgetCost=1, size="Small"}, -- UNKNOWN PROMO/SHOP ITEM
--     {decorID=16102, source={type="shop", zone="Unknown Promo/Shop item", itemID=264725, name="Unknown Promo/Shop item"}, dyeable=true, colors={"Forest Green","Gray","Purple"}, budgetCost=5, size="Large"}, -- UNKNOWN PROMO/SHOP ITEM
--     {decorID=17750, source={type="shop", zone="Unknown Promo/Shop item", itemID=266071, name="Unknown Promo/Shop item"}, dyeable=true, colors={"Dark Brown","Dark Gray","Tan"}, budgetCost=3, size="Small"}, -- UNKNOWN PROMO/SHOP ITEM
--     {decorID=21060, source={type="shop", zone="Unknown Promo/Shop item", itemID=269604, name="Unknown Promo/Shop item"}, dyeable=true, colors={"Dark Brown","Deep Red","Tan"}, budgetCost=1, size="Small"}, -- UNKNOWN PROMO/SHOP ITEM
